...
import { StatCardShimmer } from './shimmer';
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
        <div className="flex justify-between items-start mb-4">
          <div>
            ...
            <h3 className="text-3xl font-bold text-slate-900">{stats.bookingRate}%</h3>
          </div>
        ...
        <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden">
          <div className="bg-emerald-500 h-full rounded-full" style={{ width: `${stats.bookingRate}%` }}></div>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow flex items-center justify-between">
        <div>
          ...
          <h3 className="text-3xl font-bold text-slate-900">{stats.rapportScore}<span className="text-lg text-slate-400 font-normal">/10</span></h3>
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
        <div className="flex justify-between items-start mb-2">
          <div>
            ...
            <h3 className="text-3xl font-bold text-slate-900">{stats.avgCallDuration}</h3>
          </div>
